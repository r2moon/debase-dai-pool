...
contract ERC20ForDebase is Context, IERC20 {
 ...
 */
contract Debase is ERC20ForDebase, Initializable {
    ...
    constructor() public ERC20ForDebase("Debase", "DEBASE") {
        _totalSupply = INITIAL_FRAGMENTS_SUPPLY;
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);

        debasePolicy = msg.sender;
        ...
        emit Transfer(address(0x0), msg.sender, debaseDaiPoolVal);
    }
